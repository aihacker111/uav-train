...
# Detect whether the compiled CUDA extension is available.
# When not compiled, MSDeformAttn automatically falls back to the pure-PyTorch
# reference implementation (ms_deform_attn_core_pytorch).
try:
...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes,
        ...
        if self._export or value.dtype == torch.half or not _CUDA_AVAIL:
