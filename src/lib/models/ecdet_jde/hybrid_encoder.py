...
class RepNCSPELAN4(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, n=3,
        ...
        _csp_cls = CSPLayer2 if csp_type == 'csp2' else CSPLayer
        self.cv2 = nn.Sequential(_csp_cls(c3//2, c4, n, 1, bias=bias, act=act, bottletype=VGGBlock))
        self.cv3 = nn.Sequential(_csp_cls(c4, c4, n, 1, bias=bias, act=act, bottletype=VGGBlock))
